...
return [
    ...
    */
    'attributes' => [
        ...
        'available' => 'Доступно',
        'size' => 'Размер',
        'ticket.user_name' => 'Имя туриста',
        'ticket.user_phone' => 'Телефон туриста',
        'ticket.user_email' => 'Почта туриста',
        'follower.email' => 'Email',
        'ticket.name' => "Название",
        'ticket.coment' => "Комментарий",
        'ticket.limit' => "Лимит",
        'ticket.price' => "Цена",
        'ticket.limit_order_from' => "от, Лимиты на заказ(билетов в заказе)",
        'ticket.limit_order_to' => "до, Лимиты на заказ(билетов в заказе)",
        'ticket.status_date' => "Статус",
        'ticket.date_from' => "Дата начало и время начало",
        'ticket.date_to' => "Дата окончания и время окончания",
    ],
];
